...
import { emphasis } from "@/app/data/englishInContext/grammar/emphasis";
import { gerundInfinitives } from "@/app/data/englishInContext/grammar/gerundsInfinitives";
import { hedging } from "@/app/data/englishInContext/grammar/hedging";
import { inversion } from "@/app/data/englishInContext/grammar/inversion";
import { modals } from "@/app/data/englishInContext/grammar/modals";
import { participleClauses } from "@/app/data/englishInContext/grammar/participleClauses";
import { passive } from "@/app/data/englishInContext/grammar/passive";
import { relativeClauses } from "@/app/data/englishInContext/grammar/relativeClauses";
import { reportedSpeech } from "@/app/data/englishInContext/grammar/reportedSpeech";
  ...
  selectedTopic === "cleft-sentences"
    ...
    : selectedTopic === "ellipsis"
      ...
      : selectedTopic === "emphasis"
        ? emphasis
        : selectedTopic === "gerund-infinitives"
          ? gerundInfinitives
             : selectedTopic === "hedging"
          ? hedging
                 
               : selectedTopic === "inversion"
          ? inversion
                       : selectedTopic === "modals"
          ? modals  
                
                                 : selectedTopic === "participle-clauses"
          ? participleClauses  

                                      : selectedTopic === "passive"
          ? passive  

                                        : selectedTopic === "relative-clauses"
          ? relativeClauses  
...
<button
  type="button"
  onClick={() => setSelectedTopic("emphasis")}
  className={`rounded-full px-4 py-2 text-sm font-medium transition ${
    selectedTopic === "emphasis"
      ? "bg-indigo-600 text-white"
      : "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
...
<button
  type="button"
  onClick={() => setSelectedTopic("gerund-infinitives")}
  className={`rounded-full px-4 py-2 text-sm font-medium transition ${
    selectedTopic === "gerund-infinitives"
      ? "bg-indigo-600 text-white"
      : "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
...
<button
  type="button"
  onClick={() => setSelectedTopic("hedging")}
  className={`rounded-full px-4 py-2 text-sm font-medium transition ${
    selectedTopic === "hedging"
      ? "bg-indigo-600 text-white"
      : "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
...
<button
  type="button"
  onClick={() => setSelectedTopic("inversion")}
  className={`rounded-full px-4 py-2 text-sm font-medium transition ${
    selectedTopic === "inversion"
      ? "bg-indigo-600 text-white"
      : "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
...
<button
  type="button"
  onClick={() => setSelectedTopic("modals")}
  className={`rounded-full px-4 py-2 text-sm font-medium transition ${
    selectedTopic === "modals"
      ? "bg-indigo-600 text-white"
      : "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
...
<button
  type="button"
  onClick={() => setSelectedTopic("participle-clauses")}
  className={`rounded-full px-4 py-2 text-sm font-medium transition ${
    selectedTopic === "participle-clauses"
      ? "bg-indigo-600 text-white"
      : "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
...
<button
  type="button"
  onClick={() => setSelectedTopic("passive")}
  className={`rounded-full px-4 py-2 text-sm font-medium transition ${
    selectedTopic === "passive"
      ? "bg-indigo-600 text-white"
      : "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
...
<button
  type="button"
  onClick={() => setSelectedTopic("relative-clauses")}
  className={`rounded-full px-4 py-2 text-sm font-medium transition ${
    selectedTopic === "relative-clauses"
      ? "bg-indigo-600 text-white"
      : "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
...
>
 ...
 <button
  type="button"
  onClick={() => setSelectedTopic("reported-speech")}
  className={`rounded-full px-4 py-2 text-sm font-medium transition ${
    selectedTopic === "reported-speech"
      ? "bg-indigo-600 text-white"
      : "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
  }`}
>
                      ...
                      <div className="mt-2 space-y-2">
                        {item.structure.map((structureItem, index) => (
                          ...
                          >
                            ...
                            {"note" in structureItem &&
  "georgianNote" in structureItem &&
  structureItem.note && (
    <TranslationToggle
