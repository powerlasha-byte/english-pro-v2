export const questions = [
  ...
  {
    id: 2,
    question: "Are you always ready to help your friends?",
  ...
  {
    id: 3,
    question: "Should shop assistants always be ready to help customers?",
    georgianQuestion:
      "უნდა იყვნენ თუ არა მაღაზიის კონსულტანტები ყოველთვის მზად მომხმარებლების დასახმარებლად?",
    answer:
  ...
  {
    id: 4,
    question: "Do you think you're a difficult customer?",
  ...
  {
    id: 5,
    question: "Is it important to have a strategy if you want to win a war?",
    georgianQuestion: "მნიშვნელოვანია სტრატეგიის ქონა, თუ ომის მოგება გინდა?",
  ...
  {
    id: 6,
    question: "Should a good businessman always have a strategy?",
  ...
  {
    id: 7,
    question: "Why do most businesses want to attract plenty of customers?",
    georgianQuestion: "რატომ სურს ბიზნესების უმეტესობას ბევრი მომხმარებლის მოზიდვა?",
    answer:
  ...
  {
    id: 8,
    question: "Do films with big stars attract a lot of people to the cinema?",
    georgianQuestion:
      "იზიდავს თუ არა დიდი ვარსკვლავების მონაწილეობით გადაღებული ფილმები ბევრ ადამიანს კინოში?",
  ...
  {
    id: 9,
    question: "What is the minimum wage in this country?",
  ...
  {
    id: 10,
    question: "Do you think a wage of 500 dollars a week is enough for me?",
    georgianQuestion:
      "ფიქრობ, რომ კვირაში 500 დოლარის ხელფასი ჩემთვის საკმარისია?",
  ...
  {
    id: 11,
    question: "Why do people quit a job?",
  ...
  {
    id: 12,
    question: "Are you going to quit studying English this month?",
    georgianQuestion: "აპირებ ამ თვეში ინგლისურის სწავლას თავი დაანებო?",
  ...
  {
    id: 13,
    question: "How long does it take to get to the nearest airport?",
    georgianQuestion:
      "რამდენი დრო სჭირდება უახლოეს აეროპორტამდე მისვლას?",
  ...
  {
    id: 14,
    question: "How long would it take you to run a marathon?",
...

  {
    id: 15,
    question:
      "How long does it take the average person to get ready to run a marathon?",
    georgianQuestion:
      "საშუალო ადამიანს რამდენი დრო სჭირდება მარათონის გასარბენად მოსამზადებლად?",
    answer:
  ...
  {
    id: 16,
    question: "Why do most people like choosing new clothes?",
    georgianQuestion: "რატომ მოსწონს ადამიანების უმეტესობას ახალი ტანსაცმლის არჩევა?",
    answer:
...

  {
    ...
    georgianQuestion:
      "მსოფლიოს რომელ ნაწილში ირჩევენ მშობლები ქალიშვილისთვის ქმარს?",
    answer:
  ...
  {
    id: 18,
    question: "Are you always able to choose the right thing to do? Why not?",
    georgianQuestion:
      "ყოველთვის შეგიძლია სწორი საქმის არჩევა? რატომ არა?",
    answer:
  ...
  {
    id: 19,
    question: "What are the verb forms of 'choose'?",
    georgianQuestion: "რა არის ზმნა 'choose'-ის ფორმები?",
  ...
  {
    id: 20,
    question: "Have you chosen which language you're going to study next?",
    georgianQuestion: "აგირჩევია, რომელ ენას ისწავლი შემდეგ?",
  ...
  {
    id: 21,
    question: "Are you for or against killing wild animals? Why?",
    georgianQuestion:
  ...
  {
    id: 22,
    question: "Are you for or against building more roads? Why?",
    georgianQuestion:
...

  {
    id: 23,
    question:
      "What per cent of people in Europe do you think are for or against?",
    georgianQuestion:
      "შენი აზრით, ევროპის მოსახლეობის რამდენი პროცენტია მომხრე ან წინააღმდეგი?",
  ...
  {
    id: 24,
    question: "At what speed should we drive?",
    georgianQuestion: "რა სიჩქარით უნდა ვიაროთ მანქანით?",
  ...
  {
    id: 25,
    question: "Can you hear any sounds in the corridor?",
  ...
  {
    id: 26,
    question: "Do some planes fly at the speed of sound?",
  ...
  {
    id: 27,
    question: "What are the verb forms of 'fly'?",
  ...
  {
    id: 29,
    question: "Can you pilot a plane?",
  ...
  {
    id: 30,
    question: "Are people happy if their flight is late?",
    georgianQuestion: "ბედნიერები არიან ადამიანები, თუ მათი ფრენა იგვიანებს?",
  ...
  {
    id: 31,
    question: "Why do planes fly on automatic pilot?",
    georgianQuestion: "რატომ დაფრინავენ თვითმფრინავები ავტოპილოტით?",
    answer:
  ...
  {
    id: 32,
    question: "What's another word for 'plane'?",
  ...
  {
    id: 33,
    question: "Is a jet aircraft fast?",
  ...
  {
    id: 34,
    question: "What's the plural of 'aircraft'?",
  ...
  {
    id: 35,
    question: "Can passengers use their mobile phones on an aircraft?",
    georgianQuestion:
      "შეუძლიათ მგზავრებს თვითმფრინავში მობილური ტელეფონების გამოყენება?",
  ...
  {
    id: 36,
    question: "What do we call the underground in London?",
  ...
  {
    id: 37,
    question: "What's an American word for 'underground'?",
...

  {
    id: 38,
    question:
      "If you are a tourist in New York, will you take the subway?",
    georgianQuestion:
      "თუ ნიუ-იორკში ტურისტი ხარ, მეტროთი იმგზავრებ?",
  ...
  {
    id: 39,
    question: "Is the railway station near the bus station in this town?",
    georgianQuestion:
      "ამ ქალაქში რკინიგზის სადგური ავტობუსის სადგურთან ახლოს არის?",
  ...
  {
    id: 40,
    question: "Are railways expensive in this country?",
