export const questions = [
  // PAGE 1 — react / quick / allergy / dairy

  {
    id: 1,
    question: "Can people react badly to some kinds of food?",
    georgianQuestion: "შეიძლება ადამიანებმა ზოგიერთ საკვებზე ცუდად იმოქმედონ?",
  ...
  {
    id: 2,
    question: "What's the adverb of 'quick'?",
  ...
  {
    id: 3,
    question: "Does the teacher react quickly if a student doesn't know how to answer a question?",
    georgianQuestion:
  ...
  {
    id: 4,
    question: "What's the noun of 'react'?",
  ...
  {
    id: 5,
    question: "When are quick reactions necessary?",
    georgianQuestion: "როდის არის სწრაფი რეაქციები აუცილებელი?",
  ...
  {
    id: 6,
    question: "Can you add up numbers quickly?",
  ...
  {
    id: 7,
    question: "Would you go for a walk in spite of the rain?",
  ...
  {
    id: 8,
    question: "Could a person become a good pilot in spite of their slow reactions?",
    georgianQuestion:
      "შეიძლება ადამიანი კარგი პილოტი გახდეს, მიუხედავად ნელი რეაქციებისა?",
    answer:
  ...
  {
    id: 9,
    question: "What are dairy products made from?",
  ...
  {
    id: 10,
    question: "What does it mean if somebody reacts badly to some kinds of food?",
    georgianQuestion:
      "რას ნიშნავს, თუ ადამიანი ზოგიერთ საკვებზე ცუდად რეაგირებს?",
    answer:
  ...
  {
    id: 11,
    question: "Are children often allergic to dairy products or animal hair?",
    georgianQuestion:
      "ბავშვები ხშირად არიან ალერგიულები რძის პროდუქტებზე თუ ცხოველის ბეწვზე?",
    answer:
  ...
  {
    id: 13,
    question: "What kind of allergy do you have?",
  ...
  {
    id: 15,
    question: "Do you have a pen, too?",
  ...
  {
    id: 16,
    question: "Do you buy fruit at the market?",
  ...
  {
    id: 17,
    question: "Can you talk to other students during the lesson?",
    georgianQuestion: "შეგიძლია გაკვეთილის დროს სხვა მოსწავლეებთან საუბარი?",
  ...
  {
    id: 18,
    question: "Can Mark talk to other students during the lesson?",
    georgianQuestion:
      "შეუძლია მარკს გაკვეთილის დროს სხვა მოსწავლეებთან საუბარი?",
  ...
  {
    id: 19,
    question: "Will the teacher be here on Sunday?",
  ...
  {
    id: 20,
    question: "Will the students be here on Sunday?",
  ...
  {
    id: 23,
    question: "What else do you speak?",
  ...
  {
    id: 24,
    question: "What did I say at the beginning of the lesson?",
    georgianQuestion: "რა ვთქვი გაკვეთილის დასაწყისში?",
  ...
  {
    id: 26,
    question: "What else have you brought to the classroom apart from your book?",
    georgianQuestion:
      "წიგნის გარდა კიდევ რა მოიტანე კლასში?",
  ...
  {
    id: 27,
    question: "Can children be allergic to something else apart from dairy products?",
    georgianQuestion:
      "შეიძლება ბავშვები რძის პროდუქტების გარდა სხვა რამეზეც იყვნენ ალერგიულები?",
    answer:
...

  {
    ...
    georgianQuestion: "როდის ვიყენებთ Second Conditional-ს?",
    answer:
  ...
  {
    id: 29,
    question: "What's 'If I saw Ann' in your language?",
  ...
  {
    id: 30,
    question: "Do you need a train ticket when you go if you need it?",
  ...
  {
    id: 32,
    question: "Would you buy a big house if you had a million dollars?",
    georgianQuestion:
      "მილიონი დოლარი რომ გქონდეს, დიდ სახლს იყიდდი?",
  ...
  {
    id: 33,
    question: "Do you think you'll become a millionaire?",
  ...
  {
    id: 34,
    question: "Would you be happy if you became a millionaire?",
    georgianQuestion:
      "ბედნიერი იქნებოდი, მილიონერი რომ გამხდარიყავი?",
  ...
  {
    id: 35,
    question: "Will you probably see a fire in the classroom?",
    georgianQuestion:
      "ალბათ დაინახავ ხანძარს კლასში?",
  ...
  {
    id: 36,
    question: "What would you do if you saw a fire in the classroom?",
    georgianQuestion:
      "რას გააკეთებდი, კლასში ხანძარი რომ დაგენახა?",
    answer:
  ...
  {
    id: 37,
    question: "Would the teacher react quickly if the student didn't know how to answer?",
    georgianQuestion:
      "მასწავლებელი სწრაფად რეაგირებდა, მოსწავლემ პასუხის გაცემა რომ არ იცოდეს?",
    answer:
  ...
  {
    id: 38,
    question: "What would you do if you had a cold?",
    georgianQuestion: "რას გააკეთებდი, გაციებული რომ ყოფილიყავი?",
  ...
  {
    id: 39,
    question: "Would you laugh if you saw a sad film?",
    georgianQuestion:
      "იცინებდი, სევდიან ფილმს რომ უყურებდე?",
...

  {
    ...
    georgianQuestion:
      "ცხოველი რომ იყო, რომელი ცხოველი იქნებოდი?",
  ...
  {
    id: 41,
    question: "Do you think he will be ill next lesson?",
    georgianQuestion:
      "ფიქრობ, რომ ის შემდეგ გაკვეთილზე ავად იქნება?",
  ...
  {
    id: 42,
    question: "Would he come to the next lesson if he were ill?",
    georgianQuestion:
      "შემდეგ გაკვეთილზე მოვიდოდა, ავად რომ ყოფილიყო?",
  ...
  {
    id: 43,
    question: "Is this book very thick?",
  ...
  {
    id: 44,
    question: "Would you read this book if it were very thick?",
    georgianQuestion:
      "წაიკითხავდი ამ წიგნს, ძალიან სქელი რომ ყოფილიყო?",
  ...
  {
    id: 46,
    question: "Would you sleep in your bed if it were too hard?",
    georgianQuestion:
      "დაიძინებდი შენს საწოლში, ძალიან მაგარი რომ ყოფილიყო?",
  ...
  {
    id: 47,
    question: "Are you an accountant?",
  ...
  {
    id: 48,
    question: "If you were an accountant, would you be able to add up numbers quickly?",
    georgianQuestion:
      "ბუღალტერი რომ იყო, შეძლებდი რიცხვების სწრაფად შეკრებას?",
    answer:
