export const grammar = [
  {
    id: 1,
    title: "Such As",
    georgianTitle: "such as (მაგალითად)",

    rule:
      "We use 'such as' to introduce examples.",

    georgianRule:
      "'Such as' გამოიყენება მაგალითების ჩამოსათვლელად.",
...

  {
    id: 2,
    title: "One of...",
    georgianTitle: "One of + მრავლობითი",

    rule:
      "We use 'one of' before plural nouns.",

    georgianRule:
      "'One of' შემდეგ ყოველთვის მრავლობითი ფორმა გამოიყენება.",
...

  {
    id: 3,
    title: "Can / Can't",
    georgianTitle: "Can / Can't",

    rule:
      "We use 'can' to express ability and 'can't' to express inability.",

    georgianRule:
      "'Can' აღნიშნავს შესაძლებლობას, ხოლო 'can't' — შეუძლებლობას.",
...

  {
    id: 4,
    title: "Extremely",
    georgianTitle: "Extremely",

    rule:
      "'Extremely' is an adverb that makes adjectives stronger.",

    georgianRule:
      "'Extremely' გამოიყენება ზედსართავის გასაძლიერებლად.",
